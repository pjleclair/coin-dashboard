...
const MarketStats = ({ethPrice,btcPrice,setCoinToSearch,changeDisplay,totalDefiMcap,totalMcap}) => {
...
const TrendingChanges = ({trending,coinList,getCoinData}) => {
...
const TopChanges = ({getCoinData,showSlider,setShowSlider,coinList}) => {
